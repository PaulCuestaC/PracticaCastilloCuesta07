...
public class VentanaEliminarDisco extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(btnCancelar, new org.netbeans.lib.awtextra.AbsoluteConstraints(416, 321, -1, 36));

        jLabel2.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Año de lanzamiento");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(56, 201, 139, 41));

        jLabel4.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("Codigo");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(56, 91, 104, 41));

        jLabel5.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("Nombre");
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(56, 141, 104, 41));
        getContentPane().add(txtNombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(246, 151, 401, -1));
        getContentPane().add(txtAñoDeLanzamiento, new org.netbeans.lib.awtextra.AbsoluteConstraints(246, 211, 401, -1));
        getContentPane().add(txtCodigo, new org.netbeans.lib.awtextra.AbsoluteConstraints(246, 91, 401, -1));

        jLabelDisco4.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jLabelDisco4.setForeground(new java.awt.Color(255, 255, 255));
        jLabelDisco4.setText("Eliminar disco");
        getContentPane().add(jLabelDisco4, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 30, 190, 41));

        btnAceptar.setText("Aceptar");
        getContentPane().add(btnAceptar, new org.netbeans.lib.awtextra.AbsoluteConstraints(236, 321, -1, 36));
